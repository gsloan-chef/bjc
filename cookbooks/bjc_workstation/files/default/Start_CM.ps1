Write-Host -ForegroundColor Green "[1/9] Logging into automate with inspec"
...
Write-Host -ForegroundColor Green "[2/9] Uploading Planex Validation Profile"
cd C:\Users\chef\dca\
...
Write-Host -ForegroundColor Green "[3/9] Installing bjc-ecommerce on build nodes"
...
Write-Host -ForegroundColor Green "[4/9] Assimilating Hostsfile"
...
Write-Host -ForegroundColor Green "[5/9] Updating Automate Hostsfile"
...
Write-Host -ForegroundColor Green "[7/9] Nuking Automate Data"

ssh automate "sudo curl -X DELETE 'http://localhost:9200/_all' && sudo automate-ctl reconfigure"

Write-Host -ForegroundColor Green "[8/9] Updating path and loading custom functions."
$env:path = "C:\Users\chef\dca;$env:path"
Import-Module DCA_functions

Write-Host -ForegroundColor Green "[9/10] Updating knife config with aws region"
"knife[:region] = 'us-west-2'" | Out-File -encoding ASCII -append C:\Users\chef\.chef\knife.rb


Write-Host -ForegroundColor Green "[9/9] Opening Chrome Tabs & Cmder"
